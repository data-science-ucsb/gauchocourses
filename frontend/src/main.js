...
import { faInfoCircle, faEdit, faUndo,
  ...
  faExclamationCircle, faStar, faHeart, faThumbtack, faBorderAll, faColumns, faCalendar, faList, faChevronRight, faChevronDown, faCheck, faPencilAlt } from '@fortawesome/free-solid-svg-icons'
...
library.add(faInfoCircle, faUndo, faFilter, faCalendarPlus, faPlusSquare,
  faTrashAlt, faEdit, faExclamationCircle, faStar, faHeart, faThumbtack, faBorderAll, faColumns, faCalendar, faList, faChevronRight, faChevronDown, faCheck, faPencilAlt);
